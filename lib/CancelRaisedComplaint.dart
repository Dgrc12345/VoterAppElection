  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('Cancel the raised Complaint',style: TextStyle(fontSize: 14.0,color: Colors.white)),
            ...
            child: Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text('Complaint Id ',textAlign: TextAlign.left,
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'Please Enter Complaint Id ',
                ...
                Padding(
                  ...
                  child: Text('Reason for Cancelling ',textAlign: TextAlign.left,
